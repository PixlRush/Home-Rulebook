...
\fu{Pon}{Open Simples Triplet}{\ruby{中張牌}{チュウチャンパイ}\ruby{明刻}{みんこー}}
	{\upgradesto Upgrades into Kan~\pr{fu}{Kan}}
	{Have an Open Triplet of any non-orphan tile. }

\fu{Isshu Machi}{Single Tile Wait}{\ruby{一種}{いっしゅ}\ruby{待}{ま}ち}
	{\upgradesto A collective term for Tanki~Machi~\pr{fu}{Tanki Machi}, Penchan~Machi~\pr{fu}{Penchan Machi}, Kanchan~Machi~\pr{fu}{Kanchan Machi}, Kokushi~Musou~\pr{fu}{Kokushi Musou}}
...
% DONE: Kokushi is 2 Fu
\fu{Kokushi Musou}{13 Orphans Wait}{\ruby{国士無双}{こくしむそう}\ruby{待}{ま}ち}
	{\upgradesfrom A type of Isshu~Machi~\pr{fu}{Isshu Machi}\\
	\upgradesfromother Requires Kokushi Musou~\pr{yaku}{Kokushi Musou}}
	{A hand with the Kokushi Musou yaku can either be viewed as thirteen different Tankis, or a Kanchan/Penchan. All interpretations give 2 Fu.}

% DONE: Jantou instead of Toitsu?
\fu{Yakuhai Jantou}{Valued Pair}{\ruby{役牌}{やくはい}\ruby{雀頭}{じゃんとう}}
	{\upgradesto Upgrades into Yaochuuhai~Pon~\pr{fu}{Yaochuuhai Pon}\\
...
\fu{Renfuu Jantou}{Double Wind Pair}{\ruby{連風}{れんプー}\ruby{雀頭}{じゃんとう}}
	...
	\upgradesto Upgrades to Yaochuuhai~Ankou~\pr{fu}{Yaochuuhai Ankou}}
...
\fu{Yaochuuhai Ankou}{Closed Orphan Triplet}{\ruby{幺九牌}{ヤオチューハイ}\ruby{暗刻}{あんこー}}
	{\upgradesfrom Upgrades from Renfuu~Jantou~\pr{fu}{Renfuu Jantou}\\
	\upgradesto Upgrades into Yaochuuhai~Kan~\pr{fu}{Yaochuuhai Kan}\\
	\upgradesto Upgrades into Yaochuuhai~Ankan~\pr{fu}{Yaochuuhai Ankan}}
	{Have a Closed Triplet of any orphan tile.}

\fu{Kan}{Open Simples Quad}{\ruby{明槓}{みんかん}}
	{\upgradesfrom Upgrades from Pon~\pr{fu}{Pon}\\
	\upgradesfrom Upgrades from Ankou~\pr{fu}{Ankou}}
...
\fu{Yaochuuhai Kan}{Open Orphan Quad}{\ruby{幺九牌}{ヤオチューハイ}\ruby{明槓}{みんかん}}
	{\upgradesfrom Upgrades from Yaochuuhai~Pon~\pr{fu}{Yaochuuhai Pon}\\
	\upgradesfrom Upgrades from Yaochuuhai~Ankou~\pr{fu}{Yaochuuhai Ankou}}
...
% REVIEW: Remove and fold into fuutei?
