...
\yaku{Riichi}{Riichi}{リーチ}
	...
	\upgradestoother Also a declaration~\pr{decl}{Riichi}}
...
\yaku{Jikaze}{Seat Wind}{\ruby{自風}{じかぜ}}
	...
	\upgradesto Upgrades into Suushiihou~\pr{yaku}{Suushiihou}}
...
\yaku{Chanta}{Half Outside Hand}{\ruby{混全帯幺九}{ホンチャンタイヤオチュウ}}
...
\yaku{Renfuu}{Double Wind}{\ruby{連風}{れんプー}}
	...
	\upgradesto Upgrades to Suushiihou~\pr{yaku}{Suushiihou}}
...
\yaku{Menzen Chanta}{Closed Half Outside Hand}{\ruby{門前}{メンゼン}\ruby{混全帯幺九}{ホンチャンタイヤオチュウ}}
	{\closedhand \\ 
...
\yaku{Junchan}{Full Outside Hand}{\ruby{純全帯幺九}{ジュンチャンタイヤオチュウ}}
...
\yaku{Honitsu}{Half Flush}{\ruby{混一色}{ホンイーツー}}
	{\morevaluable More Valuable if Closed~\pr{yaku}{Menzen Honitsu}\\
...
\yaku{Menzen Junchan}{Closed Fully Outside Hand}{\ruby{門前}{メンゼン}\ruby{純全帯幺九}{ジュンチャンタイヤオチュウ}}
	{\closedhand \\ 
...
% DONE: Add Renhou
\yaku{Renhou}{Blessing of Man}{\ruby{人和}{レンホー}}
	{\closedhand \\
	\brokenhand}
	{While you are not the dealer, win before your first draw.}
...
\yaku{Suushiihou}{Four Winds}{\ruby{四喜和}{スーシーホー}}
...
% DONE: Is Suuankou a closed hand?
